...
function showResults() {
    ...
    console.log('Assessment Results:', { score, correct, total: questions.length, passed });
    
    quizSection.style.display = 'none';
    resultsSection.style.display = 'block';
    
    // Ensure score display exists and add animation class
    if (scoreDisplay) {
    ...
    if (window.parent && window.parent !== window) {
        console.log('Sending results to parent window:', { score, correct, totalQuestions: questions.length, passed });
